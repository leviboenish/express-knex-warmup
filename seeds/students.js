  ...
  return knex('students').del()
    .then(function () {
      ...
      return knex('students').insert([
        ...
        {firstname: 'Austin', lastname: 'Loveless', prevoccupation: 'Navy', hometown: 'Long Beach, CA'},
        {firstname: 'Tiffany', lastname: 'Ricks', prevoccupation: 'CNA', hometown: 'Scottsdale, AZ'},
        {firstname: 'Levi', lastname: 'Boenish', prevoccupation: 'Manager', hometown: 'Boulder, CO'}
      ]);
    });
};
